...
if __name__ == '__main__':
    ...
    print(hit_dic)
    new_hit_dic={}
    new_hit_dic['喜悦'], new_hit_dic['积极'], new_hit_dic['愤怒'], new_hit_dic['伤感'], new_hit_dic['焦虑'], =hit_dic['喜悦'], hit_dic['积极'], hit_dic['愤怒']+hit_dic['厌恶'], hit_dic['伤感'], hit_dic['焦虑'],

    js = json.dumps(new_hit_dic, indent=4, separators=(',', ':'), ensure_ascii=False)
    print(js)
