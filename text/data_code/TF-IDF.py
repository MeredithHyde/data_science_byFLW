...
if __name__ == '__main__':
    ...
    with open('other_data\\stop','r',encoding="utf-8") as sf:#未用停词表
...
##IDF
    wordList = jieba.lcut("".join(contents))
    wordList_noRepeat=[]
    N=len(contents)
    print("总文章数：",N)
    IDF={}
...
#TF
    ...
    t = getCurrentTime()
    with open("other_data\\" + k + ".json", 'w+', encoding='utf-8') as f:
        f.write(js)
